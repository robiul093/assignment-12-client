...
const DetailsCard = ({ item }) => {
    ...
    // console.log(item);
    const { description, title, category, creationDate, deadline, status, _id, question } = item;
    ...
    console.log(activeItemId, _id, question);
    ...
    const handelSubmit = (e) => {
        ...
        const answer = { question1Ans, question2Ans, question3Ans }
        ...
        <div className="card card-side items-center bg-base-100 shadow-xl p-6 gap-5">
            ...
            <div className="card-body">
                ...
                <div className="flex justify-between border-t-2 border-t-gray-500 border-dashed py-8">
                    <h3 className="text-lg font-medium bg-[#859770] px-5 w-[200px] py-4 rounded-xl "> Total Voat :  </h3>
                    <h3 className="text-lg font-medium bg-[#859770] px-5 w-[200px] py-4 rounded-xl "> Status : {status} </h3>
                </div>

                <div className="flex justify-between border-t-2 border-t-gray-500 border-dashed py-8">
                    <h3 className="text-lg font-medium bg-[#859770] px-5 w-[200px] py-4 rounded-xl "> Total Yes Vote : { } </h3>
                    <h3 className="text-lg font-medium bg-[#859770] px-5 w-[200px] py-4 rounded-xl "> Total No Vote : { } </h3>
                </div>

                <div className="flex justify-between border-t-2 border-t-gray-500 border-dashed py-8">
                    <h3 className="text-lg font-medium bg-[#859770] px-5 w-[250px] py-4 rounded-xl "> Create : {creationDate} </h3>
                    <h3 className="text-lg font-medium bg-[#859770] px-5 w-[250px] py-4 rounded-xl "> Deadline : {deadline} </h3>
                </div>

                <div className="flex justify-between border-t-2 border-t-gray-500 border-dashed py-8">
                    <h3 className="text-lg font-medium bg-[#859770] px-5 w-[300px] py-4 rounded-xl "> Category : {category} </h3>
